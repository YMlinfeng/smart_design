...
from app.utils_toB.models import RouterMode, SwitchParamsMode
from app.utils_toB.prompt import get_know_rag_prompt,get_router_prompt,get_switch_params_prompt
from app.utils_toB.constants import ALIYUN_API_KEY,ALIYUN_BASE_URL
...
) | get_llm('qwen-plus-latest',temperature=0.0,top_p=0.9)
...
# RAG处理链：模板 -> LLM
rag_chain = rag_prompt | get_llm('qwen-flash',temperature=0.7,top_p=0.9)
